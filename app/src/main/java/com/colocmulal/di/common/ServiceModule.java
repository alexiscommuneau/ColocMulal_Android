...
import com.colocmulal.data.net.retrofit.ColocMulal_AndroidService;
import com.colocmulal.data.net.retrofit.model.RestError;
import com.colocmulal.utils.crashes.HockeyAppCrashManagerListener;
import com.colocmulal.utils.logging.InterceptorLogger;
...
public class ServiceModule {
    ...
    @Provides @Singleton
    ColocMulal_AndroidService provideService(Retrofit retrofit) {
        return retrofit.create(ColocMulal_AndroidService.class);
    }
